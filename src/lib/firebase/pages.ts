...
export function buildPageUpdate(
  ...
  const updates: UpdateData<DocumentData> = {
    ...
    "profile.descriptionFont": n.profile.descriptionFont ?? "geist",
    "profile.descriptionColor": n.profile.descriptionColor,
    "profile.descriptionBold": Boolean(n.profile.descriptionBold),
    "profile.descriptionItalic": Boolean(n.profile.descriptionItalic),
    "profile.descriptionFontSize": n.profile.descriptionFontSize ?? "md",
